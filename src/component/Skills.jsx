        ...
        <div data-aos="fade-down">
            <div className="row justify-content-center align-items-center my-5"  id='Skills'>
                <div className="col-md-6">
                    ...
                    <label>HTML & CSS/Sass & Bootstrap</label>
                    ...
                    <label>JavaScript & React JS</label>
                                    ...
                                    <div className="card-body">
                                        <div className="row justify-content-center mb-3">
                                            ...
                                            <div className="col-12">
                                                <h4 className="card-title text-center">Osama</h4>
                                                <p className="card-text text-secondary text-center">Sur-Solution's Client</p>
                                            </div>
                                        </div>
                                        <p className="card-text mb-3">Provided fully interactive and user-friendly application which met our expectations. Delivery time is also fast as promised.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card border-secondary border-2 bg-dark text-white my-2">
                                    <div className="card-body">
                                        <div className="row justify-content-center mb-3">
                                            ...
                                            <div className="col-12">
                                                <h4 className="card-title text-center">Faseeh</h4>
                                                <p className="card-text text-secondary text-center">Project Reviewer</p>
                                            </div>
                                        </div>
                                        <p className="card-text mb-3">Built best project amoung students, fully functional in both ffrontend and backend</p>
                                    </div>
                                </div>
                            </div>
                            {/* <div className="carousel-item">
